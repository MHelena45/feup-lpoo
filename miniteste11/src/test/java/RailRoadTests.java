...
public class RailRoadTests  {
	...
	public void testSubclassesComboio() {		
		Comboio tgv = new Carruagem.TGV("Speeder");
	...
	public void testImprimeDadosDoComboio() throws PassengerCapacityExceeded {
		...
		Comboio c2 = new Carruagem.TGV("Speeder");
		c2.addCarruagem(new Carruagem(1));

		assertEquals("Carruagem.TGV Speeder, 1 carruagem, 1 lugar, 0 passageiros", c2.toString());
	}
	...
	public void testServicoABordo() {		
		...
		// Os Carruagem.TGV's teem por defeito o servico prioritario
		Comboio c2 = new Carruagem.TGV("Speeder");
